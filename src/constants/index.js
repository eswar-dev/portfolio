...
"Developed innovative solutions using React.js, React Native, TypeScript, and Material UI, delivering 5+ key features that improved performance and user engagement across applications",
  ...
  "Worked with the EVES, EVES stands as a pinnacle of innovation,engineered to seamlessly integrate, offer interoperability comprehensive analytics, and ensure universal charger compatibility. Crafted as an intelligent solution, it delivers unparalleled efficiency and reliability for seamless user experience and optimized business performance."
    ],
  },
  {
    title: "SDE - Full-Stack Web Developer (Intern)",
    company_name: "VM Online Training",
    icon: vm,
    iconBg: "#E6DEDD",
...
"Leveraged behavior science (Psychology) and data science (machine learning and AI) to create personalized user experiences, improving user retention by 20%."
  ...
  },
  {
    ...
    company_name: "Safe Send Gathers",
    icon: shopify,
    iconBg: "#383E56",
...
"Worked in gather project which is all about tax paying applications"]
  },
...
"I created an eCommerce website with React.js, Node.js, and MongoDB, featuring product ordering and voice search, deployed on AWS EC2 using Docker and Nginx" ,
   tags: [
    ...
    image: carrent,
    source_code_link: "https://github.com/eswar-dev/Meta-Ecommerce",
  },
  {
...
"It is a web application that provides nutrition information and cooking instructions for various foods and recipes, featuring user login, lazy loading, search options, and social media sharing",    tags: [
  ...
  },
  {
    ...
    image: tripguide,
    source_code_link: "https://github.com/eswar-dev/chat-messanger",
  },

  {
    ...
    image: tripguide,
    source_code_link: "https://github.com/eswar-dev/Iyzer-frontend",
  },
];
